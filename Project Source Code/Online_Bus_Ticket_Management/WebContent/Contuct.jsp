...
<div class="main">
  ...
  <section id="content">
    ...
    <div class="wrapper pad1">
      ...
      <h1>Dear Passangers, Give your precisous comments/Suggession/Feedback here.
      
               <div class="comment">
               
 
<textarea rows="15" cols="70"  name="Comments" form="usrform" placeholder="writh something...">
</textarea>
<form action="ContactServlet" method="POST" id="usrform">


<input type="submit" name="submit" value="Submit" class="sbtn" style="height: 37px;
width: 80px;
