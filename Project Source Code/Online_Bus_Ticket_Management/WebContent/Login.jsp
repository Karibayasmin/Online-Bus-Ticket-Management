...
<div class="main">
    ...
    <article class="col1">
        <div class="pad_bot3">
          <div class="box1">
            ...
            <form id="form_4" action="login_servlet" method="post">
              <div>
     ...
     <div class="pad_bot3">
          <div class="box1">
            ...
            <form id="form_4" action="LoginSignup" method="post">
              <div>
                ...
                <div class="row"> <span class="left">Mobile Number</span>
                  <input type="text" class="input" name="mobile">
                </div>
                
                  <div class="wrapper"> <span class="right relative"> <input type="submit" value ="Sign Up"class="button1"></span> </div>
              </div>
            </form>
          </div>
        </div>
  ...
  <footer>
    <div class="wrapper">
      ...
      <div class="links">Copyright © <a href="file:///C:/Users/Kariba%20Yasmin/Desktop/LICT%20PROJECT/Login.html#">LICT</a> All Rights Reserved<br>
        Design by <a target="_blank" href="file:///C:/Users/Kariba%20Yasmin/Desktop/LICT%20PROJECT/Login.html#DOMAIN%20LINK">LICT.com</a></div>
    </div>
  </footer>
  <!--footer end-->
</div>
