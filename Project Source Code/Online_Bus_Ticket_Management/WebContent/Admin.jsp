...
<div class="main">
  ...
  <section id="content">
    <div class="wrapper pad1">
     ...
     <div class="pad_bot3">
          <div class="box1">
            <h2 class="top">Enter the Bus Details</h2>
            <form 
            
                action="Admin_servlet" method="post">
                Bus Name<input type="text" name="Bus_name"/></br>
                From To <input type="text" name="FromTo"/></br>
                Available Seat<input type="text" name="Available_seat"/></br>
...
<h2 align="center"><font><strong>Show the Passanger Details</strong></font></h2>
...
<tr bgcolor="#A52A2A">
<td><b>id</b></td>
<td><b>Ticket Reciever Name</b></td>
<td><b>Travel Time</b></td>
<td><b>Seat Booking</b></td>
...
String sql ="SELECT * FROM ticket_confirm";
...
%>
      ...
      <div class="pad_bot3">
          ...
          <h2 align="center"><font><strong> Delete  Passanger Information</strong></font></h2>
          
          <center>
      
          <form action="PassangerInfoDelete" method="post">
          <b>Enter id Name you want to Delete:</b>
   ...
   <!-- <article class="col1">
      <div class="pad_bot3">
          ...
          <h2 align="center"><font><strong>Update of Bus Information</strong></font></h2>
          
          <center>

          <form action="UpdateBusInfo" method="post">
          <b>Enter id Name you want to change:</b>
          <input type="text" name="id"><br>
      ...
      <div class="pad_bot3">
          ...
          <h2 align="center"><font><strong>Delete Bus Information</strong></font></h2>
          
          <center>
          <form action="BusInfoDelete" method="post">
          <b>Enter id Name you want to Delete:</b>
          <input type="text" name="id"><br>
          <input type="submit" value="Delete">  
          </form>
